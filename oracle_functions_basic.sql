...
SELECT FIRST_NAME || ' ' || LAST_NAME AS FULL_NAME,
       NVL(TO_CHAR(SALARY * commission_pct), 'NO COMMISSION') 
FROM EMPLOYEES;

--트랜잭션 실습
SELECT * FROM DEPARTMENTS;

--커밋하기 전에는 디스크에 저장 안된다. 
INSERT INTO DEPARTMENTS
(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID)
VALUES (99, 'IT', NULL, 1700);

INSERT INTO DEPARTMENTS
(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID)
VALUES (299, 'WOW', NULL, 1700);
--ROLLBACK; COMMIT 하기전에 롤백을 해야한다. 
--COMMIT을 하기전에는 다른 접속에서는 위의 99 IT가 반영되지 않는다. 
--DELETE와 달리 TRUNCATE는 COMMIT이 바로 된다. DDL은 트랜젝션 제어문이 필요없이 바로 반영된다.

--DDL
SELECT * FROM EMP_11;

INSERT INTO EMP_10 (C1, C2) VALUES (1, 'A');
INSERT INTO EMP_10 (C1, C2) VALUES (2, 'B');
COMMIT;
--DELETE는 커밋하기전에는 안 지워진다.
DELETE FROM EMP_10;
ROLLBACK;

--COMMIT을 안해도 바로 다 반영된다.
TRUNCATE TABLE EMP_10;

--COMMIT없이 바로 반영된다. 
ALTER TABLE EMP_10 ADD (C3 DATE);
ALTER TABLE EMP_10 RENAME TO EMP_11;
DROP TABLE EMP_11;
